...
public class CheckoutActivity extends AppCompatActivity {
    ...
    private void handleIntentData() {
        try {
            ...
            if (vehicle == null) {
                ...
                showErrorAndFinish(getString(R.string.toast_vehicle_information_missing));
                return;
            }
            ...
            showErrorAndFinish(getString(R.string.toast_error_loading_checkout_data));
        }
    }
    ...
    private void loadParkingSessionData() {
        if (vehicle == null || vehicle.getId() == null) {
            ...
            showErrorAndFinish(getString(R.string.toast_invalid_vehicle_information));
            return;
        }
        ...
        api.checkout(request).enqueue(new Callback<CheckoutResponse>() {
            ...
            public void onResponse(Call<CheckoutResponse> call, Response<CheckoutResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(CheckoutActivity.this, getString(R.string.toast_checkout_failed), Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        Toast.makeText(CheckoutActivity.this, getString(R.string.toast_invalid_checkout_request), Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
