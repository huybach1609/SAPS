...
import retrofit2.Retrofit;
import retrofit2.converter.gson.GsonConverterFactory;
import vn.edu.fpt.sapsmobile.network.interceptor.AuthTokenInterceptor;
    ...
    private static Retrofit createRetrofitInstance(String baseUrl, Context context) {
        ...
        try {
            ...
            Gson gson = new GsonBuilder()
                    ...
                    // With timezone (e.g. "2025-08-16T12:34:56+07:00")
                    //.setDateFormat("yyyy-MM-dd'T'HH:mm:ssXXX")

                    // With Zulu time (UTC, "2025-08-16T12:34:56Z")
