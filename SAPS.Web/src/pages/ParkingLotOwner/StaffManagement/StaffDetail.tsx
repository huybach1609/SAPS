...
const StaffDetailScreen = () => {
  const { parkingLotId, staffId } = useParams<{
    parkingLotId: string;
    staffId: string;
  }>();
  ...
  return (
    <>
      <Link href="/owner/staff" className="my-5">
        <CornerUpLeft size={16} /> return to staff list
      </Link>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex items-center space-x-6">
            <div className="relative">
              ...
              />
              <div
                className={`absolute -bottom-1 -right-1 px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(staffData?.userStatus ? staffData?.userStatus : "")}`}
              >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-medium">
                    {formatDate(
                      staffData?.createdAt ? staffData?.createdAt : ""
                    )}
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-medium">
                    {formatDate(
                      staffData?.updatedAt ? staffData?.updatedAt : ""
                    )}
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-900 font-medium">
                    {staffData?.parkingLotId}
                  </p>
                </div>
                <div
                  className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(staffData?.parkingLotStatus ? staffData?.parkingLotAddress : "")}`}
                >
