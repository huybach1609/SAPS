  ...
  if (!selectedParkingLot) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="mt-2 text-sm font-medium text-background-900">
          No parking lot found
        </h3>
        <p className="mt-1 text-sm text-background-500">
          Get started by creating a new parking lot.
        </p>
      </div>
    );
  }
              ...
              <div className="bg-background-50 rounded-lg p-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-background-900/50 mt-1">
                      Cannot be modified - Contact support to update
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="bg-background-50 rounded-lg p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="">
                      {formatDate(selectedParkingLot.createdAt)}
                    </p>
                    <p className="text-sm text-background-900/50 mt-1">
                      Registration date in SAPLS system
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className=" bg-background-50 rounded-lg p-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h4 className="text-lg font-semibold text-background-900">
                    {user?.fullName}
                  </h4>
                  <div className="mt-2 space-y-1">
                    ...
                    {user?.phone && (
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-background-950">
                          {user.phone}
                        </span>
                      </div>
                    )}
                  </div>
                  <p className="text-sm  mt-3 text-background-900/50">
                    Owner details cannot be modified
                  </p>
                </div>
              </div>
            </div>
              ...
              <ModalBody className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditFormData((prev) => ({
                        ...prev,
                        totalParkingSlot: parseInt(e.target.value) || 0,
                      }))
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <label
                        htmlFor="useWhitelist"
                        className="text-sm font-medium text-gray-900"
                      >
                        Use whitelist
                      </label>
                      <p className="text-sm text-gray-500">
                        Enable whitelist to restrict parking to pre-approved
                        vehicles only
                      </p>
                    </div>
                  </div>
