...
import { ParkingFeeSchedule, VehicleType } from "@/services/parkinglot/parkinglotFeeService";
                ...
                <form id="fee-schedule-form" onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            onSelectionChange={(e) => setFormData({ ...formData, forVehicleType: parseInt(e.currentKey as string) as VehicleType.Car | VehicleType.Motorbike | VehicleType.Bike })}
                        ...
                        >                         
                           {/* <SelectItem key={VehicleType.Car} >{VehicleTypeText[VehicleType.Car]}</SelectItem> */}
                            <SelectItem key={VehicleType.Car} >{VehicleTypeText[VehicleType.Car]}</SelectItem>
                            <SelectItem key={VehicleType.Motorbike} >{VehicleTypeText[VehicleType.Motorbike]}</SelectItem>
                            <SelectItem key={VehicleType.Bike} >{VehicleTypeText[VehicleType.Bike]}</SelectItem>
                        </Select>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 ">
                        ...
                        <Input
                            ...
                            onChange={(e) => setFormData({ ...formData, initialFeeMinutes: parseInt(e.target.value) || 60 })}
                            className=""
                            required
                        />
                        <p className="text-xs text-gray-500 mt-1">
                            Initial fee applies for the first {formData.initialFeeMinutes} minutes
                        </p>
                    </div>
                    ...
                    <div className="bg-muted p-4 rounded-lg">
                        ...
                        <div className="text-sm  space-y-1">
                            <div>• Initial fee: {formData.initialFee.toFixed(2)} VND for first {formData.initialFeeMinutes} minutes</div>
                            <div>• Additional fee: {formData.additionalFee.toFixed(2)} VND per {formData.additionalMinutes} minutes</div>
